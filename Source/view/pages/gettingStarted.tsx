				...
				<div className="container">
					...
					<div id="CPX" className="inv">
						...
						<h3 className="normalFontWeight">
							> Import the Circuit Playground library to use it
							(This is required)
						</h3>
						...
						<ul>
							<li>
								Push Button: <kbd>A</kbd> for Button A,{" "}
								<kbd>B</kbd> for Button B, <kbd>C</kbd> for
								Buttons A & B
							</li>
							<li>
								Refresh the simulator: <kbd>Shift</kbd> +{" "}
								<kbd>R</kbd>
							</li>
							<li>
								Run the simulator: <kbd>Shift</kbd> +{" "}
								<kbd>F</kbd>
							</li>
						</ul>
					</div>
					...
					<div id="CLUE" className="inv">
						...
						<p>
							Make sure there are bitmap (.bmp) pictures of your
							choice in the same directory as the code file.
						</p>
						<span className="codeBox">
						...
						<ul>
							...
							<li>
								Capacitive Touch Sensor: <kbd>Shift</kbd> +{" "}
								<kbd>1</kbd> ~ <kbd>7</kbd> for GPIO pins A1 -
								A7
							</li>
							<li>
					...
					<div id="debugger" className="inv">
						...
						<h3 className="normalFontWeight">> Enter debug mode</h3>
						<p>
							Press <kbd>F5</kbd> or go to{" "}
							<code>Run -> Start Debugging</code>
						</p>
						<img
							alt="Start debugging"
						...
						<p>
							Stopping at a breakpoint pauses the program at that
							particular place.
						</p>
						...
						<ul>
							...
							<li>
								<kbd>F10</kbd> to step over (execute current
								statement and all functions that it calls and
								stop before the next statement)
							</li>
							<li>
								<kbd>F11</kbd> to step into (stop at first
								statement of first function called from first
								line)
							</li>
							<li>
								<kbd>Shift</kbd> + <kbd>F11</kbd> to step out
								(run current function to end)
							</li>
							<li>
								<kbd>Ctrl</kbd> + <kbd>Shift</kbd> +{" "}
								<kbd>F11</kbd> to restart
							</li>
							<li>
								<kbd>Shift</kbd> + <kbd>F5</kbd> to stop
							</li>
						</ul>
						<img
