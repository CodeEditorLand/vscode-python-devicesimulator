...
export class ClueSvg extends React.Component<IProps, {}> {
	...
	private updateNeopixel() {
		...
		const rgbColor = `rgb(${
			neopixel[0] + (255 - neopixel[0]) * CONSTANTS.LED_TINT_FACTOR
		},
        ${neopixel[1] + (255 - neopixel[1]) * CONSTANTS.LED_TINT_FACTOR},${
			neopixel[2] + (255 - neopixel[2]) * CONSTANTS.LED_TINT_FACTOR
		})`;
